...
<head>
    ...
    <meta name="description" content="Automotive and Architectural Window Film | LLumar">
    <meta name="author" content="LLumar Indonesia">

    <!-- OG Meta Tags to improve the way the post looks when you share the page on LinkedIn, Facebook, Google+ -->
    <meta property="og:site_name" content> <!-- website name -->
    <meta property="og:site" content> <!-- website link -->
    <meta property="og:title" content="LLumar | JKIND"> <!-- title shown in the actual shared post -->
    <meta property="og:description" content="Automotive and Architectural Window Film | LLumar"> <!-- description shown in the actual shared post -->
                ...
                <div class="col-md-5 col-lg-5">
                    <div class="card login-signup-card shadow-lg mb-0">
                        ...
                        <div class="card-footer border-top px-md-5 text-center" style="background-color: #fffffe;">
                            <a href="https://jkind.co.id"><img src="{{  asset('assets/images/logo/logo-bpjs.png') }}" alt="logo-bpjs" srcset="{{  asset('assets/images/logo/logo-bpjs.png 15x') }}"></a>
                        </div>
                    </div>
                </div>
            </div>
