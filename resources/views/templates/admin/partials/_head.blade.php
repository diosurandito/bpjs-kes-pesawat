...
<head>
    ...
    <link rel="shortcut icon" sizes="32x32" href="{{ asset('assets/images/icon/logo.ico') }}">
    <link rel="icon" type="image/png" sizes="192x192" href="{{ asset('assets/images/icon/logo.ico') }}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('assets/images/icon/logo.ico') }}">
    <!-- END Icons -->
